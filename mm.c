...
/* Names: Allen Severino, Joel Colon
   IDs: 31200419, 32009330
...
int mm_init () {
  ...
  // That avoids the coalsece with its preceding block.
...
void mm_free (void *ptr) {
  ...
  // Update block header and footer
    ...
    *(size_t*)UNSCALED_POINTER_ADD(blockInfo, payloadSize - WORD_SIZE) = payloadSize;
